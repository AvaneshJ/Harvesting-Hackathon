...
class MediaPlayer:
    def __init__(self, window):
        ...
        self.song_photo.place(x=0,y=0)

        # self.heading = tk.Label(self.root, bg="black",text="Music Player",font="Algerian 40  ",fg="#F4B81A")
        ...
        self.songs_list.place(x=820, y=60)
        ...
        self.music_duration_label.place(x=660,y=400)

        self.progress_scale = ttk.Scale(self.root,orient="horizontal",style='TScale',from_=0,length=550,
                                        command=self.progress_scale_moved,cursor='hand2')
        self.progress_scale.place(x=100,y=400)
        ...
        self.play_button.place(x=246,y=425)

        # seperate pause button
        self.pause_button = tk.Button(self.root,image=self.pause_icon,command=self.pause,cursor='hand2',bd=0,
                                      background=background,activebackground=background)
        self.pause_button.place(x=146,y=425)
